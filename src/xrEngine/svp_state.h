...
public:
	...
	// Virtual eye for true-PiP scopes. Logic publishes whether a weapon action has broken
	// the cheek weld; the render thread owns the follower state and updates it once per frame.
