...
void CWeapon::UpdateSecondVP()
{
	...
	// Aim transitions retain normal eye tracking. Reloads and other pending weapon actions
	// break the cheek weld, so the virtual eye must not follow the animated scope.
